...
public class WedDayAdapter extends RecyclerView.Adapter<WedDayAdapter.ViewHolder> {

    Context context;
    ArrayList<ClassTimeModelClass> arrayList = new ArrayList<>();

    public WedDayAdapter(Context context, ArrayList<ClassTimeModelClass> arrayList) {
    ...
    @NonNull
    @Override
    public WedDayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_sample_layout,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WedDayAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Wed").child(classTimeModelClass.getStartClass()).removeValue();
                    }
