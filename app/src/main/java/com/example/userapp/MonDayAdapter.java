...
public class MonDayAdapter extends RecyclerView.Adapter<MonDayAdapter.ViewHolder> {
    ...
    public MonDayAdapter(Context context, ArrayList<ClassTimeModelClass> arrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MonDayAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Mon").child(classTimeModelClass.getStartClass()).removeValue();
                    }
