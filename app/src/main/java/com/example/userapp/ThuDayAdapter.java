...
public class ThuDayAdapter extends RecyclerView.Adapter<ThuDayAdapter.ViewHolder> {

    Context context;
    ArrayList<ClassTimeModelClass> arrayList = new ArrayList<>();

    public ThuDayAdapter(Context context, ArrayList<ClassTimeModelClass> arrayList) {
    ...
    @NonNull
    @Override
    public ThuDayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_sample_layout,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ThuDayAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Thu").child(classTimeModelClass.getStartClass()).removeValue();
                    }
