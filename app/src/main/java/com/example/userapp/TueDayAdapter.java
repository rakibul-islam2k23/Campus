...
public class TueDayAdapter extends RecyclerView.Adapter<TueDayAdapter.ViewHolder> {

    Context context;
    ArrayList<ClassTimeModelClass> arrayList = new ArrayList<>();

    public TueDayAdapter(Context context, ArrayList<ClassTimeModelClass> arrayList) {
    ...
    @NonNull
    @Override
    public TueDayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_sample_layout,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TueDayAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Tue").child(classTimeModelClass.getStartClass()).removeValue();
                    }
