...
public class SatDayAdapter extends RecyclerView.Adapter<SatDayAdapter.ViewHolder> {

    Context context;
    ArrayList<ClassTimeModelClass> arrayList = new ArrayList<>();

    public SatDayAdapter(Context context, ArrayList<ClassTimeModelClass> arrayList) {
    ...
    @NonNull
    @Override
    public SatDayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_sample_layout,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SatDayAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Sat").child(classTimeModelClass.getStartClass()).removeValue();
                    }
